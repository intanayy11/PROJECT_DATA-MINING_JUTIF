...
<a href="{{ url()->previous() }}" class="btn btn-outline text-xs"><i class="fas fa-arrow-left"></i> Kembali</a>
@endsection
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="col-span-2 space-y-4">
        <div class="card">
            ...
            <div class="flex flex-wrap gap-3 text-sm text-gray-500 mb-4">
                ...
                <a href="{{ $article->url }}" target="_blank" class="text-blue-500 hover:underline">
                    <i class="fas fa-external-link mr-1"></i>Lihat di JUTIF
                </a>
                @endif
            </div>
        ...
        @if($similar->count() > 0)
        <div class="card">
            <h3 class="font-bold text-gray-700 mb-3"><i class="fas fa-layer-group mr-2 text-blue-500"></i>Artikel dalam Klaster yang Sama</h3>
            <div class="space-y-2">
    ...
    <div class="space-y-4">
        ...
        <div class="card" style="border-top: 4px solid {{ $c['bg'] }}">
            <div class="text-xs font-semibold text-gray-500 uppercase mb-2">Klaster</div>
            ...
            <a href="{{ route('clustering.show', $article->cluster) }}" class="btn btn-outline text-xs w-full justify-center">
                <i class="fas fa-layer-group"></i> Lihat Klaster Ini
            </a>
        </div>
        ...
        <div class="card text-xs text-gray-500 space-y-2">
            ...
            <div class="flex justify-between"><span>Tahun Terbit</span><span class="font-medium text-gray-700">{{ $article->year }}</span></div>
            <div class="flex justify-between"><span>Jumlah Keywords</span><span class="font-medium text-gray-700">{{ $article->kw_tokens_count ?? '-' }}</span></div>
